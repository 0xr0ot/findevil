...
```
python ~/bin/volatility/vol.py -f ~/AMF_MemorySamples/windows/sample001.bin --profile=WinXPSP2x86 findevilproc                     
Volatility Foundation Volatility Framework 2.5                                                                                                                      
Creating Dump Dir /Users/thalfpop/findevil/dump_tmp                                                                                                                 
Name                 Result                    Verdict    Signed   Entropy      Yara                                                                                
-------------------- ------------------------- ---------- -------- ------------ ----                                                                                
smss.exe             OK: executable.356.exe    {} / {}    Unsigned 5.723...5913 [test.yar]                                                                   
csrss.exe            OK: executable.604.exe    {} / {}    Unsigned 3.927...0292 [test.yar]                                                                   
winlogon.exe         OK: executable.628.exe    1 / 56     Unsigned 3.059...7028 [test.yar]                                                                   
services.exe         OK: executable.680.exe    {} / {}    Unsigned 6.009...4422 [test.yar]                                                                   
lsass.exe            OK: executable.692.exe    {} / {}    Unsigned 0.318...9337 [test.yar]                                                                   
...
spoolsv.exe          OK: executable.1348.exe   {} / {}    Unsigned 3.887...3312 [test.yar]                                                                   
